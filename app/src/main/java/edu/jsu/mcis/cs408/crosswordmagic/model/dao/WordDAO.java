    ...
    public Word find(SQLiteDatabase db, int id) {
        ...
        if (cursor.moveToFirst()) {
            ...
            do {
                ...
                params.put(daoFactory.getProperty("sql_field_row"), cursor.getString(cursor.getColumnIndexOrThrow(daoFactory.getProperty("sql_field_row"))));
                params.put(daoFactory.getProperty("sql_field_column"), cursor.getString(cursor.getColumnIndexOrThrow(daoFactory.getProperty("sql_field_column"))));
                params.put(daoFactory.getProperty("sql_field_box"), cursor.getString(cursor.getColumnIndexOrThrow(daoFactory.getProperty("sql_field_box"))));
                params.put(daoFactory.getProperty("sql_field_direction"), cursor.getString(cursor.getColumnIndexOrThrow(daoFactory.getProperty("sql_field_direction"))));
                params.put(daoFactory.getProperty("sql_field_word"), cursor.getString(cursor.getColumnIndexOrThrow(daoFactory.getProperty("sql_field_word"))));
                params.put(daoFactory.getProperty("sql_field_clue"), cursor.getString(cursor.getColumnIndexOrThrow(daoFactory.getProperty("sql_field_clue"))));
